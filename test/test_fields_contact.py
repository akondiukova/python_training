...
def test_fields_contact(app,orm):
    ...
    for contact in old_contacts:
        contact_from_home_page = app.contact.get_contact_info_by_id(contact.id)
        assert contact.last_name == contact_from_home_page.last_name
        assert contact.first_name == contact_from_home_page.first_name
